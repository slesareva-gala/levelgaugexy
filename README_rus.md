...
\- **\'rgba (...)\'** - оформлять тенью указанным цветом rgb;  
Значение по умолчанию установлено в \'rgba (200,200,200,0.9)\'.

**colorLevel**  
Цвет уровнемеров.  
Значение: **\'rgba (...)\'** - оформлять тенью указанным цветом rgb.  
Значение по умолчанию установлено в \'rgba (100,100,100,0.3)\'.
